...
//    }
    ...
    public Theraphy2 getTherapyByAppointmentId(Integer appointmentId) {
        ...
        Theraphy2 theraphy2 = restTemplate.getForObject("http://gateway-service:8080/api/v1/theraphies/getTherapyByAppointment/" + appointmentId, Theraphy2.class);
        return theraphy2;
    }
...
//    }
    ...
    public Theraphy2 getTherapyById(Integer therapyId){
        Theraphy2 therapy = restTemplate.getForObject("http://gateway-service:8080/api/v1/theraphies/" + therapyId, Theraphy2.class);
        return therapy;
    }
